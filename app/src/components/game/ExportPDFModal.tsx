      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-zinc-950 border border-zinc-800 rounded-[40px] shadow-2xl overflow-hidden flex flex-col"
          >
            {/* Header */}
            <div className="p-8 border-b border-zinc-800 flex items-center justify-between bg-zinc-900/30">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl font-black uppercase tracking-tighter text-white">Forjar Livro</h2>
            ...
            <div className="p-8 space-y-8">
              <div className="text-center space-y-2">
                 <p className="text-zinc-400 font-serif italic text-lg">"Como as crônicas de {playerName} devem ser imortalizadas?"</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <button 
                  ...
                  className={`w-full p-5 rounded-3xl border-2 text-left transition-all flex items-center justify-between group ${
                    includeImages ? 'border-primary bg-primary/5' : 'border-zinc-800 bg-zinc-900/50 hover:border-zinc-700'
                  }`}
                >
                  <div className="flex items-center gap-4">
                    <div className={`p-3 rounded-xl transition-colors ${includeImages ? 'bg-primary text-zinc-950' : 'bg-zinc-800 text-zinc-500'}`}>
                      <ImageIcon className="w-5 h-5" />
                    </div>
                    <div>
                      <h3 className={`font-black uppercase tracking-tight ${includeImages ? 'text-white' : 'text-zinc-400'}`}>Livro de Arte Completo</h3>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className={`font-black uppercase tracking-tight ${!includeImages ? 'text-white' : 'text-zinc-400'}`}>Apenas Crônicas</h3>
            ...
            {/* Footer */}
            <div className="p-8 border-t border-zinc-800 bg-zinc-900/30 flex gap-3">
               <button 
                onClick={onClose}
